...
import { initUser } from '@/Redux/Reducers/sliceUser';
...
export const selectCourse = (state: AppState) => state.choosenCourse
export const selectSpecialty = (state: AppState) => state.choosenSpecialty
